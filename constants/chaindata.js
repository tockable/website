const BASE_FEE = {
  ...
  DMT_TOCKABLE: Number(process.env.NEXT_PUBLIC_DMT_TOCKABLE),
  DMT_REGULAR: Number(process.env.NEXT_PUBLIC_DMT_REGULAR),
};
...
export const chainData = [
  ...
  },
  {
    ...
    verifyurl: "https://explorer.ham.fun/contract-verification",
    name: "ham",
    scan: "Explorer.ham.fun",
    nativeToken: "ETH",
    base_fee: BASE_FEE.ETH_TOCKABLE,
    regular_base_fee: BASE_FEE.ETH_REGULAR,
  },
  {
    ...
    verifyurl: "https://explorer.sanko.xyz/contract-verification",
    name: "sanko",
    scan: "Explorer.sanko.xyz",
    nativeToken: "DMT",
    base_fee: BASE_FEE.DMT_TOCKABLE,
    regular_base_fee: BASE_FEE.DMT_REGULAR,
  },
  // {
  //   chainId: 61166,
  ...
  //   verifyurl: "https://shapescan.xyz/contract-verification",
  //   name: "shape",
  //   scan: "Shapescan.xyz",
  //   nativeToken: "ETH",
  //   base_fee: BASE_FEE.ETH_TOCKABLE,
  ...
  //   verifyurl: "https://explorer.arena-z.gg/contract-verification",
  //   name: "arena-z",
  //   scan: "Explorer.arena-z.gg",
  //   nativeToken: "ETH",
  //   base_fee: BASE_FEE.ETH_TOCKABLE,
  //   regular_base_fee: BASE_FEE.ETH_REGULAR,
  // },
