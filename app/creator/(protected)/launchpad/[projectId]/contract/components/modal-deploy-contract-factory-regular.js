...
import { capitalize, camelize } from "@/utils/string-utils";
import { TockableRegularDropFromFactoryV1DeployerV1Abi } from "@/contracts/TockableRegularDropFromFactoryV1DeployerV1Abi";

export default function DeployContractFactoryRegularModal({
  onClose,
  project,
}) {
  ...
  const { config } = usePrepareContractWrite({
    ...
    abi: TockableRegularDropFromFactoryV1DeployerV1Abi,
    functionName:
