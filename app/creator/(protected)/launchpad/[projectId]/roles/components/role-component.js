...
import UploadCsvModal from "./modal-uploadcsv";
...
export default function Role({
  ...
  const handleShowUploadCsvModal = () => setShowUploadCsvModal(true);
  const handleCloseUploadCsvModal = () => setShowUploadCsvModal(false);
