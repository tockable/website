    ...
    <div>
      <div className="p-4 border border-zinc-600 rounded-2xl mb-4 bg-zinc-800">
        ...
        <LabeledInput
          ...
          subtitle={
            <p>
              <span className="text-tock-orange">DISCLAIMER: </span>Currently,
              date and time fields are only for display and setting the date and
              time does not make the contract change sessions automatically.
