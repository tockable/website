...
// File contracts/RegularDrop.sol
...
contract TockableContractName is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    function tokenURI(
        ...
        string memory ext = hasExtension ? ".json" : "";
        return string(abi.encodePacked(baseURI, _toString(tokenId), ext));
    }
